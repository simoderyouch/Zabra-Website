...
export default function Navbar() {
    ...
    return (
        <nav className="w-full  top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#0a1a0f] via-[#0f2818] to-[#0a1a0f] border-b border-[rgba(212,175,55,0.15)]  transition-all duration-300">
            <div className="container mx-auto px-6 py-5 lg:px-12 lg:py-6 flex items-center justify-between max-w-[1400px]">
                ...
                {/* Navigation Wrapper */}
                <div className="hidden md:flex flex-row items-center gap-6 lg:gap-8 text-[13px] lg:text-[14px] font-bold text-white uppercase tracking-widest relative z-10">
                    ...
                    <div className="flex items-center gap-1.5 cursor-pointer hover:bg-white/10 transition-colors group px-3 py-1.5 rounded-full border border-transparent hover:border-white/20">
