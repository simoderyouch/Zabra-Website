...
const terroirs = [
    {
        ...
        description: 'Our extra virgin olive oil is cold-pressed in Beni Mellal, a region renowned for centuries for the exceptional quality of its olive groves. Each batch is pressed within hours of harvest to preserve the full freshness of the aromas.',
    ...
    },
    {
        ...
        description: 'Naturally caramelized Medjool dates, hand-selected from the ancestral palm groves of the Ziz Valley. Each date is individually inspected for generous size, intact skin, and perfectly soft flesh.',
